...
const Header = () => {
  ...
  return (
    <header
      className={`header z-30 ${settings.sticky_header && "sticky top-0"} dark:bg-darkmode-theme-light`}
    >
      <nav className="navbar container">
            ...
            <React.Fragment key={`menu-${i}`}>
              {menu.hasChildren ? (
                ...
                <li className="nav-item">
                  <Link
                    href={menu.url}
                    className={`nav-link block  font-light ${
        ...
        <div className="order-1 ml-auto flex items-center md:order-2 lg:ml-0">
          ...
          {customizer_button.enable && (
            <Link
              className="customizer btn btn-outline-primary btn-sm hidden lg:inline-block normal-case"
              href={customizer_button.link}
            >
              {customizer_button.label}
            </Link>
